...
class DataParallelPPOActor(BasePPOActor):
    ...
    def update_policy(self, data: DataProto) -> dict[str, Any]:
        ...
        print("Preparing mini-batches for PPO update...")
        print(f"Total batch size per device: {self.config.global_batch_size_per_device}")
        print("length1",len(data.batch["input_ids"]))
        try:
            print("length2",len(data))
        except:
            pass
        ...
        for _ in range(self.config.ppo_epochs):
            ...
            for mini_batch in mini_batches:
                ...
                if self.config.dynamic_batching:
                    ...
                    print("mini batch size:", len(mini_batch))
